...
namespace MFramework.Common.Specifications
{
    ...
    public class Specification<T> : ISpecification<T>
    {
        ...
        public static Specification<T> True = new Specification<T>(t=> true);
        public static Specification<T> False = new Specification<T>(t => true);
        public static Specification<T> None = True;
